...
function Hero() {
  return (
    <div className="bg-[#11235A] md:px-24 md:py-24 px-6 py-6 flex flex-col items-center justify-center md:grid md:grid-cols-2 transition-all ease-in duration-500">
      <div >
        ...
        <div className="text-gray-300 mb-4">
          I'm a Front-end web developer | App developer who enjoys creating/building websites.
