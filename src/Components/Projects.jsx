  ...
  return (
    <div className="bg-[#11235A] md:px-24 px-6 py-6">
      ...
      <div className="md:flex md:flex-wrap gap-6  ">
        ...
        <div className="bg-[#11235A] md:w-[48%]  h-96 shadow-lg shadow-blue-500/20 hover:shadow-blue-500/80 rounded my-6">
       ...
       <Link to='/movies-app'>
        ...
        <div className="bg-[#11235A] md:w-[48%] h-96 shadow-lg shadow-blue-500/20 hover:shadow-blue-500/80 rounded my-6">
         <Link to='/barber-booking-app'>
          ...
          <p className="flex flex-col justify-center items-center p-3">
            <span className="text-white text-xl">Barber Appointment Booking App</span>
            <span className="text-gray-200 text-center text-sm">
              An app for booking appointments with a barber by selecting date, time, and service.
